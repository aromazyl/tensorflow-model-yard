...
def main(args):
    ...
    loss = content_loss + style_loss + beta * tv_loss
        ...
        try:
            while not coord.should_stop():
                ...
                if (current_step % num_steps_ckpt == 0):
                    ...
                    summary, _, loss_out, c_loss, s_loss, t_loss = sess.run([merged, optimizer, loss, content_loss, style_loss, tv_loss],
                                                    feed_dict=feed_dict)
